...
LOGO_DETECT_DATASET_DIR = os.path.join(LOGO_DETECT_ROOT_DIR, 'runtime/logoDetector/Datasets/')
LOGO_DETECT_DATASET_DIR = os.path.normpath(LOGO_DETECT_DATASET_DIR)
print("Dataset Dir: ", LOGO_DETECT_DATASET_DIR)

LOGO_DETECT_LOGS_DIR = os.path.join(LOGO_DETECT_ROOT_DIR, "runtime/logoDetector/trainingLogs")
MODEL_PATH = os.path.join(LOGO_DETECT_ROOT_DIR, 'runtime/logoDetector/model.h5')
